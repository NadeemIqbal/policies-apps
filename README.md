...
- **Merge Drop** — [privacy policy](https://nadeemiqbal.github.io/policies-apps/merge-drop/privacy-policy/) ([source](merge-drop/privacy-policy/index.html))
- **FlowConnect** — [privacy policy](https://nadeemiqbal.github.io/policies-apps/flow-connect/privacy-policy/) ([source](flow-connect/privacy-policy/index.html))
